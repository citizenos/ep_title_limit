 ...
 * collectContentPre
 *
 * This hook is called before the content of a node is collected by the usual methods.
 * The cc object can be used to do a bunch of things that modify the content of the pad.
 * See, for example, the heading1 plugin for etherpad original.
 *
 ...
 *
 * If you want to specify also a value,
 * call cc.doAttrib(state, "attributeName::value")
